class ExampleRecipe extends RecipeBase   // Our example recipe which uses primary ingredient - our custom item MagicHammer to turn any other secondary ingredient ( all ItemBase items ) into stones. 
{
	override void Init()
	{
		m_Name = "Transmogrify";	// action name in game
		...
		//ingredient 1  
		InsertIngredient(0,"MagicHammer");	// primary ingredient
		...
		//ingredient 2	
		InsertIngredient(1,"Inventory_Base"); //  secondary ingredient
		...
		//result
		AddResult("SmallStone");	// recipe result
